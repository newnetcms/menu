...
@section('page_title', __('menu::menu.edit.page_title'))
...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active">{{ trans('menu::menu.edit.breadcrumb') }}</li>
        </ol>
    </nav>
@stop
...
@section('content')
    <div class="row">
        ...
        <div class="col-12 col-md-6">
            <form action="{{ route('menu.admin.menu.update', $item->id) }}" method="POST">
                @method('PUT')
                @csrf
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        @include('menu::admin.menu._fields', ['item' => $item])
                    </div>
